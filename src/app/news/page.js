            ...
            <div className="grid grid-cols-3 bg-white p-4 rounded">
                ...
                <div className="col-span-2 ps-3 flex items-center">
                    <div>
                        ...
                        <p>ໃນວັນທີ 01/02/2024 ໄດ້ເລີ່ມຂຽນໂຄດ ເວັບຄອດເພງ ຈຳປາຄອດ. ໂດຍແຜນການລິເລີ່ມຂອງສອງສ່ຽວລະຫວ່າງສອງປະເທດຄື ສຸລິໄຊ ກັບ Hàn Quốc Trung(ຫ່ານ ກວັກ ຈຸງ) ຄົນຫວຽດນາມ</p>
                    </div>
                </div>
            </div>
        </>
